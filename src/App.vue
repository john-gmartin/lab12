<template>
  <div class="app">
    ...
    v-bind:key="index"
    v-bind:imagenPadre="tweet.user.image"
    v-bind:altPadre="tweet.user.alt"
    v-bind:mensajePadre="tweet.message"
    v-bind:namePadre="tweet.user.name"
    v-bind:handlePadre="tweet.user.handle"
    v-bind:timestampPadre="tweet.timestamp"
    />
  </div>
</template>
